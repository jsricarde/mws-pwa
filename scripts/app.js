...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    localforage.getItem('selectedCities', (err, cityList) => {
  ...
  document.getElementById('butAddCity').addEventListener('click', function () {
    ...
    const item = { key: key, label: label };
    app.selectedCities.push(item);
    app.storageCities();
  ...
  app.storageCities = () => {
    localforage.setItem('selectedCities', app.selectedCities).then((value) => {
      // Do other things once the value has been saved.
      console.log('storageCities', value);
    }).catch((err) => {
      // This code runs if there were any errors
      console.log('storageCities error:', err);
    });
  };
